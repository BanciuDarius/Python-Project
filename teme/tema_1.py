...
print('/n 15.citeste un user de la tastatura citeste o parola afiseaza Parola: pt user x este ***** si are x caractere ***** se va calcula dinamic, indiferent de dimensiunea parolei, trebuie sa afiseze corecteg: parola abc => *** parola abcd => **** /n ' )
